<template>
  <article
    class="flex flex-col w-full h-full p-8 border-2 border-primary hover:border-secondary bg-accent rounded-xl transition-all duration-200 text-gray-700 cursor-pointer"
